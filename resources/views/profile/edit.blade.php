<x-app-layout>
    <div class="max-w-2xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div class="mb-8">
            <h1 class="text-3xl font-extrabold text-gray-900 dark:text-white mb-2">Editar Perfil</h1>
        ...
        <form method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data" class="space-y-6 bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 p-8">
            @csrf
            @method('PATCH')
            ...
            <div>
                ...
                <div class="relative">
                    <input type="text" name="name" value="{{ old('name', $user->name) }}" 
                           class="w-full px-4 py-3 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 dark:focus:ring-orange-400 transition-colors placeholder-gray-400 dark:placeholder-gray-500 text-gray-900 dark:text-white">
                ...
                <div class="flex items-center space-x-6">
                    <div class="relative">
                        <img src="{{ $user->avatar ? asset('storage/'.$user->avatar) : 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80' }}"
                             class="w-20 h-20 rounded-full object-cover border-4 border-orange-200 dark:border-orange-900/50 shadow-lg">
                        <div class="absolute -bottom-1 -right-1 bg-gradient-to-r from-orange-500 to-red-600 rounded-full p-1 shadow-lg border border-white dark:border-gray-800">
