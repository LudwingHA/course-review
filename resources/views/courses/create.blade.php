<x-app-layout>
    <div class="max-w-3xl mx-auto py-10">
        <h1 class="text-3xl font-bold text-gray-800 dark:text-gray-100 mb-6">Crear nuevo curso</h1>
        ...
        <form method="POST" action="{{ route('courses.store') }}" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <textarea id="content_table" name="content_table" rows="3"
                    class="block w-full rounded-md border-gray-300">{{ old('content_table') }}</textarea>
            </div>
