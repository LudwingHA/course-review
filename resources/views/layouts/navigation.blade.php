        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            @auth
                ...
                <div class="mt-3 space-y-1">
                    <x-responsive-nav-link :href="route('profile.public', Auth::user())">
                        {{ __('Ver perfil público') }}
                    </x-responsive-nav-link>
            ...
            @guest
                <div class="px-4 space-y-2">
                    <a href="{{ route('login') }}" class="block text-gray-600 hover:text-blue-600">Iniciar sesión</a>
                    <a href="{{ route('register') }}" class="block text-gray-600 hover:text-blue-600">Registrarse</a>
                </div>
            @endguest
        </div>
    </div>
